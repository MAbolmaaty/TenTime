...
public class ArtistTab_SingleActivity extends Fragment {
    ...
    private static void changeButton() {
        if(myTrackadAdaptor!=null){
            myTrackadAdaptor.notifyDataSetInvalidated();}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        bundle = getArguments();
        if (bundle != null)
            mAlbumList = bundle.getParcelableArrayList("msinglelist");
        Log.e("msinglelist", mAlbumList + "");
    ...
    private void InitlizeUi() {
        ArtistTabsActivity.selectedfragment = 3;
        selectessong = -1;
        ...
        if (mAlbumList != null && mAlbumList.size() > 0)
            ...
            //Toast.makeText(context, getResources().getString(R.string.no_search_result), Toast.LENGTH_LONG).show();
        }
    }

    private void setRecycleitemClick(int position) {
