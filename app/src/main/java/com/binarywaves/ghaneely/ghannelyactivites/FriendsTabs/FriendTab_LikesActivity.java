...
public class FriendTab_LikesActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // bundle = getArguments();
        if (AppSingleTon.getInstance().getLikes() != null)
            mAlbumList = AppSingleTon.getInstance().getLikes();
...
// add the decoration to the recyclerView
    ...
    private void InitlizeUi() {
        selectessong = -1;
        FriendsTabActivity.selectedfragment = 1;
        ...
        lvtrack.setOnItemClickListener((parent, view, position, id) -> { // TODO Auto-generated method stub
    ...
    private void setRecycleClick(int position) {
