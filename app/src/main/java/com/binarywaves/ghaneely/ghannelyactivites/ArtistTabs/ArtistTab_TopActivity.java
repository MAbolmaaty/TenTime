...
public class ArtistTab_TopActivity extends Fragment {
...
if(progBar!=null&&pb1!=null) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        bundle = getArguments();
        if (bundle != null) {
            mAlbumList = bundle.getParcelableArrayList("top20");
            Log.e("top20", mAlbumList + "");
        }
        InitlizeUi();
        return activityView;
    }
    ...
    private void InitlizeUi() {
        ArtistTabsActivity.selectedfragment = 0;
        selectessong = -1;
