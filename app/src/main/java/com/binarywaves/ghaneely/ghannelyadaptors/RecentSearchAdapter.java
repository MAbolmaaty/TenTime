...
/**
 * Created by Amany on 15-May-17.
 */

public class RecentSearchAdapter extends ArrayAdapter<GetRecentUserSearchesListResponse> {
    private int layoutResourceId;
    // public ImageLoader imageLoader;
    private List<GetRecentUserSearchesListResponse> data;
    private Context mContext;

    public RecentSearchAdapter(Context context, int layoutResourceId,
        ...
        if (getActivity() != null) {
            ...
            if (mtTrack.getContentImage() == null || mtTrack.getContentImage() == "") {
                ...
                switch (Integer.valueOf(mtTrack.getContentTypeId())) {
                    ...
                    case 5:
                        Picasso.with(mContext)
                                .load((ServerConfig.Video_Imagepath + mtTrack.getContentImage()))
                                .error(R.mipmap.defualt_img)
                                .placeholder(R.mipmap.defualt_img).into(holder.imageItem);
                        Picasso.with(mContext)
                                .load(R.mipmap.videoclipwhite)
                                .error(R.mipmap.defualt_img)
                                .placeholder(R.mipmap.defualt_img).into(holder.ivoverlay);
                        break;
                }
