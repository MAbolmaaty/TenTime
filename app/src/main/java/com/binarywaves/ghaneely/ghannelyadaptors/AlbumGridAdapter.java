...
public class AlbumGridAdapter extends ArrayAdapter<SlideAlbumObject> {
    private int layoutResourceId;
    private ArrayList<SlideAlbumObject> data = new ArrayList<>();
    private Context mContext;

    public AlbumGridAdapter(Context context, int layoutResourceId,
                            ArrayList<SlideAlbumObject> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.txtTitle = row.findViewById(R.id.tvsingername);
            holder.tvsongname = row.findViewById(R.id.tvsongname);
        ...
        if (language.equalsIgnoreCase("ar")) {
            holder.tvsongname.setText(mplaylist.getAlbumArName());
            holder.txtTitle.setText(mplaylist.getSingerArName());

        }
        if (language.equalsIgnoreCase("en")) {
            holder.tvsongname.setText(mplaylist.getAlbumEnName());
